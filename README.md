...
---
# Licenses
This project is licensed under the  [![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](LICENSE). 

Distributed under the [![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE.md).
...
``` 
![Snake animation](https://github.com/MAX25M/qlite/blob/output/github-snake.svg)
